...
func main() {
	...
	str1 := "Welcome, to the, online portal, of abhicodeitout"
	...
	res4 := strings.Split("", "abhicodeitout, abhis")
...
func main() {
	...
	res4 := strings.SplitAfterN("", "abhicodeitout, abhis", 3)
...
func main() {
	...
	res4 := strings.SplitAfter("", "abhicodeitout, abhis")
